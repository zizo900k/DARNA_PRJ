                    ...
                    Row(
                      children: [
                        ...
                        if (property.area > 0) ...[
                          ...
                          const SizedBox(width: 4),
                          Text('${property.area} m²', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: theme.textTheme.bodyMedium?.color)),
                        ],
                      ],
                    ),
