    ...
    return Padding(
      ...
      child: Wrap(
        ...
        children: favorites.asMap().entries.map((entry) {
          ...
          final favItem = entry.value;
          // The backend returns the property details inside a 'property' key
          final item = favItem['property'] ?? favItem; 
          
          final width = (MediaQuery.of(context).size.width - 48) / 2;
          return TweenAnimationBuilder<double>(
            key: ValueKey(item['id'] ?? favItem['id']),
            tween: Tween(begin: 0.0, end: 1.0),
            duration: Duration(
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () => context
                              ...
                              .removeFavorite(item['id'] ?? favItem['id'] as int),
                          child: Container(
                            width: 36,
                            height: 36,
